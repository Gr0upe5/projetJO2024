...
<body class='bg-dark'>
	...
	<div class='container text-center'>
		...
		<h1 class="text-light position-relative">Olympics' Traveler</h1>
	</div>
        ...
        <li class="nav-item">
            <div class="dropdown">
                <a class="btn btn-secondary dropdown-toggle mr-2" href="#" role="button" id="dropdownMenuSports" data-toggle="dropdown">Sports</a>
        ...
        <li class="nav-item">
            <div class="dropdown">
                <a class="btn btn-secondary dropdown-toggle mr-5" href="#" role="button" id="dropdownMenuSports" data-toggle="dropdown">Villes</a>
                <div class="dropdown-menu">
        ...
        <li>
            <form class="form-inline">
                ...
                <button class="btn btn-outline-light bg-secondary my-sm-0" type="submit">Rechercher</button>
            </form>
        </li>
    </ul>
    ...
    <div id="fiche-site" class="container mx-auto">
        <div class="bg-light">
            <button id="quit-button" class="bg-light float-left">✕</button>
            <button id="prev-button" class="bg-light float site-button ">&laquo;</button>
            <button id="next-button" class="bg-light float-right site-button">&raquo;</button>

        </div>
        <div class="bg-secondary">
            <h2 class="bg-light text-center" id="site-title"></h2>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm">
                    <h4>Epreuves</h4>
                    <p id="epr-site">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe magni magnam, alias laborum necessitatibus suscipit perferendis enim hic, nesciunt fugit aperiam blanditiis voluptas architecto labore iusto repudiandae distinctio! Molestias, nulla?
                    </p>
                </div>
                <div class="col-sm">
                    <h4>Lieux à visiter</h4>
                    <p id="visit-site">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae hic eius ab. Accusantium, culpa ducimus eveniet laborum, dolores a fugiat error facere officia praesentium eaque nulla voluptatibus! Voluptates, doloremque ut!
                    </p>
                </div>
            </div>
        </div>
	...
	<!--Footer-->
		<footer class="container bg-light mt-5">
			<div>
				<p id="footer-descr">
					Cette application web a été developpé dans le cadre d'un hackathon organisé par l'école DORANCO sur le theme des Jeux Olympiques de 2024.<br>
